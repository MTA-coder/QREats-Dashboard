...
export class AsideComponent implements OnInit, OnDestroy {
  ...
  constructor(private layout: LayoutService, private router: Router, private _user: UserService) { }
  ...
  logout() {
    if (this._user.getUser() != null) {
      this._user.logoutRequest().subscribe((response: any) => {
        this._user.logout();
